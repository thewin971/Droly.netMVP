...
| `POST /api/free-trial` | page d'accueil, « Générer ma vidéo gratuite » | une vraie vidéo offerte, sans compte : une par email, une par connexion et par jour, et un plafond quotidien pour tout le site |
| `POST /api/free-trial-status` | page d'accueil, toutes les 5 s | suit la vidéo gratuite jusqu'à ce qu'elle soit prête |
...
Toutes les adresses sauf `config`, `stripe-webhook`, `free-trial` et `free-trial-status` exigent un client connecté
